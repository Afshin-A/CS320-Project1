# CS320-Project1
In this project, I have developed and tested back-end services by applying software testing principles and techniques using JUnit5.
...
This project is my take-off into bonafide software testing. Previously, I would create temporary `main` methods to ensure my classes/methods would function as intended. As such, my mindset has always been to show absence of error. But since that is not possible to prove, a software tester's goal should be to find defects, not the lack thereof. In that aim, he/she would write tests that truly challenge the software, resulting in higher product quality. Attributes of  such tests were discussed [earlier in this document](#2-defend-the-overall-quality-of-your-junit-tests-in-other-words-how-do-you-know-your-junit-tests-were-effective-based-on-the-coverage-percentage).
